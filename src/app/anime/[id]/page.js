...
function AnimeDetails() {
  ...
  // --- SCHEMA MARKUP START (Sirf Google Bots ke liye) ---
  const schemaData = {
    "@context": "https://schema.org",
    "@type": "TVSeries",
    "name": animeData?.display_name || animeData?.title || "Anime Details",
    "description": animeData?.description || "Watch Hindi Dubbed Anime on MeraAnime",
    "image": tmdb.poster || animeData?.poster,
    "genre": animeData?.genres?.join(", "),
    "aggregateRating": {
      "@type": "AggregateRating",
      "ratingValue": tmdb.rating || "8.5",
      "bestRating": "10",
      "ratingCount": tmdb.votes || "500"
    }
  };
  // --- SCHEMA MARKUP END ---
              ...
              <div className="relative">
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                     ...
                     <h2 className="text-[10px] font-black uppercase tracking-[0.5em] opacity-40">Synopsis Intelligence</h2>
                  </div>
          ...
          <div className="mt-32">
            ...
            <div className="flex items-center gap-6 mb-12 group">
               ...
               <div>
                  ...
                  <p className="text-[9px] font-black uppercase tracking-[0.4em] opacity-20">Comprehensive Data Archive</p>
               </div>
